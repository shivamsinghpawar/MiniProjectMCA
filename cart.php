...
<?php
        ...
        if(isset($_GET['place']))
                 {  
                    ...
                    $query1="DELETE FROM cart where Customer='$customer'";
        ...
        if(isset($_GET['remove']))
                 {  $product=$_GET['remove'];
					...
					$product1=$_GET['remove'];
                    $query1="DELETE FROM ord where Customer='$customer' AND Product='$product1'";
                    $result=mysqli_query($con,$query1);
                 ?>
                    <script type="text/javascript">
	...
	if(isset($_SESSION['user']))
	    {   
	            ...
	            {   
                        ...
                        $query="SELECT * from ord where Customer='$customer' AND Product='$product'";
                        $result=mysqli_query($con,$query);
                        $row = mysqli_fetch_assoc($result);
                        if(mysqli_num_rows($result)==0)
	                         { $query="INSERT INTO ord values('$customer','$product','$quantity')"; 
                              $result=mysqli_query($con,$query);
                            $query1="INSERT INTO cart values('$customer','$product','$quantity')"; 
                              $result=mysqli_query($con,$query1);
                        ...
                        echo ' 
                         ...
                         <div class="row">
                             <div class="col-xs-9 col-xs-offset-3 col-sm-2 col-sm-offset-5 col-md-2 col-md-offset-5">
                                  <a href="index.php" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;">Back to Main Website</a>
                             </div>
                          </div>';
                     }               
	    }
